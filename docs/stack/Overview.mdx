...
![](../../static/img/introduction/arch1.png)
...
![](../../static/img/introduction/arch2.png)
...
![](../../static/img/introduction/arch3.png)
...
- The [Store VTEX IO WebOps](/stack/1): a CI pipeline focused on crucial ecommerce metrics values and code quality. 
...
:::tip
We understand, however, that freedom can be scary sometimes. That's why, to help you build your store frontend, we deliver the [Faststore](/stack/2) - a set of libraries that supports integrations with headless ecommerce platforms, provides ecommerce-focused React components and GA4 compatible analytics functions.
:::
...
![](../../static/img/introduction/arch4.png)

With so much creativity and freedom space, what we offer is a safe environment for experimenting. By connecting with a Git provider and thanks to our team of QA robots, our Control Plane is apt to run E2E tests, evaluate code quality, and measure the impact of each Pull Request on a store's performance. 
